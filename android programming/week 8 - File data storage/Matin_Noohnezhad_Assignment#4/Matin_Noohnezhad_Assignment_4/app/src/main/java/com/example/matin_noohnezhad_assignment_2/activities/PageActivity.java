...
//        System.exit(0);
    ...
    private void writeFileProcess() {
        ...
        String content = JsonConverter.toJson(TaskListHolder.getDueTaskList(), TaskListHolder.getArchivedTaskList());
    ...
    private void readFileProcess() {
        ...
        TaskListHolder.concatToDueTask(dueTasks);
        TaskListHolder.concatToArchivedTask(archivedTasks);
