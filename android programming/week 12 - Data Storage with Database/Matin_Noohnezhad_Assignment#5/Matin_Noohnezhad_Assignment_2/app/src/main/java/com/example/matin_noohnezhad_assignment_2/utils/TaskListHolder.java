...
public class TaskListHolder {
    ...
    private static List<Task> dueTaskList;
    //    private static List<Task> dueTaskList = generateDueTaskList();
    private static List<Task> archivedTaskList;
//    private static List<Task> archivedTaskList = generateArchivedTaskList();


    public static void setDueTaskList(List<Task> dueTaskList) {
        TaskListHolder.dueTaskList = dueTaskList;
    }

    public static void setArchivedTaskList(List<Task> archivedTaskList) {
        TaskListHolder.archivedTaskList = archivedTaskList;
    }
