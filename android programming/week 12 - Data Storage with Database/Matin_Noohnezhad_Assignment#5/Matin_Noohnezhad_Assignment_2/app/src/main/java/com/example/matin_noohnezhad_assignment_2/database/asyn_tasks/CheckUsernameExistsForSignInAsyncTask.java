...
public class CheckUsernameExistsForSignInAsyncTask extends AsyncTask<String, Void, List<User>> {

    private Context context;
    private AppDatabase appDatabase;
    private UserDao userDao;

    public CheckUsernameExistsForSignInAsyncTask(Context context) {
    ...
    protected void onPostExecute(List<User> users) {
        ...
        ((MainActivity) context).afterGetUserFromDB(users);
    }
}
