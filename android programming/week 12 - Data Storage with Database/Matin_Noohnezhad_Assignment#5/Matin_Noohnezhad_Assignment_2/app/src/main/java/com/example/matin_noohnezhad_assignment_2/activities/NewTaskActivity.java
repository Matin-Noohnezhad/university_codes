...
import com.example.matin_noohnezhad_assignment_2.database.asyn_tasks.AddNewTaskAsyncTask;
...
//        Log.i("day", String.valueOf(day));
        if (type.equals("") || type == null || title.equals("") || title == null || dueHour.equals("") || dueHour == null || dueMinute.equals("") || dueMinute == null || date.equals("") || date == null) {
            ...
            int uid = PageActivity.getCurrentUser().getUid();
            newTask = new Task(taskType, title, description, new GregorianCalendar(year, month - 1, day).getTime(), dueHour, dueMinute, uid);
            //
            AddNewTaskAsyncTask antat = new AddNewTaskAsyncTask(this);
            antat.execute(newTask);
        }
    }
...
//            stlat.execute(PageActivity.getCurrentUser().getUid());
