...
plotData(X, y, xl='Microchip Test 1', yl='Microchip Test 2',filename="ex2")
...
import my_minimizer as mm
lambda_ = 1
alpha = 0.01
theta = mm.minimizer(X,y,lambda_,initial_theta,xtol=1e-6,alpha=alpha,max_repeat=10000)
print(alpha)
print(lambda_)
